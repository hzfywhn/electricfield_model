...
# no 00:00:00-00:02:00 and 23:58:00-24:00:00, skip
...
gmlat_out = dataout.createVariable(varname='gmlat', datatype='f', dimensions=('time', 'nrec'))
gmlong_out = dataout.createVariable(varname='gmlong', datatype='f', dimensions=('time', 'nrec'))
kvect_out = dataout.createVariable(varname='kvect', datatype='f', dimensions=('time', 'nrec'))
vlos_out = dataout.createVariable(varname='vlos', datatype='f', dimensions=('time', 'nrec'))
vlos_sd_out = dataout.createVariable(varname='vlos_sd', datatype='f', dimensions=('time', 'nrec'))
